...
namespace Stock.UI.Migrations
{
    ...
    [Migration("20220303094208_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stock.Domain.Entities.ConcreteProduct", b =>
                {
                    ...
                    b.Property<string>("AuthorOfProductUsername")
                        .IsRequired()
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("AuthorOfProductUsername");
            ...
            modelBuilder.Entity("Stock.Domain.Entities.ConcreteProduct", b =>
                {
                    b.HasOne("Stock.Domain.Entities.Author", "AuthorOfProduct")
                        .WithMany()
                        .HasForeignKey("AuthorOfProductUsername")
